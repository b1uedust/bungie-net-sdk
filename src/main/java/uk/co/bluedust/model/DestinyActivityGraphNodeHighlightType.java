...
public enum DestinyActivityGraphNodeHighlightType {
  ...
  DestinyActivityGraphNodeHighlightType(Integer value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DestinyActivityGraphNodeHighlightType fromValue(String text) {
    for (DestinyActivityGraphNodeHighlightType b : DestinyActivityGraphNodeHighlightType.values()) {
