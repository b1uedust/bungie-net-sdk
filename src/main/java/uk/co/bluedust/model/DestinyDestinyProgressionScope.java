...
public enum DestinyDestinyProgressionScope {
  ...
  DestinyDestinyProgressionScope(Integer value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DestinyDestinyProgressionScope fromValue(String text) {
    for (DestinyDestinyProgressionScope b : DestinyDestinyProgressionScope.values()) {
