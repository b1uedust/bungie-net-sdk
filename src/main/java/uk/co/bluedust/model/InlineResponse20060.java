...
import uk.co.bluedust.model.SearchResultOfCommunityLiveStatus;
...
public class InlineResponse20060 {
  ...
  private SearchResultOfCommunityLiveStatus response = null;
  ...
  public InlineResponse20060 response(SearchResultOfCommunityLiveStatus response) {
  ...
  **/
  ...
  public SearchResultOfCommunityLiveStatus getResponse() {
    return response;
  }

  public void setResponse(SearchResultOfCommunityLiveStatus response) {
    this.response = response;
  }

  public InlineResponse20060 errorCode(ExceptionsPlatformErrorCodes errorCode) {
  ...
  **/
  ...
  public InlineResponse20060 throttleSeconds(Integer throttleSeconds) {
  ...
  **/
  ...
  public InlineResponse20060 errorStatus(String errorStatus) {
  ...
  **/
  ...
  public InlineResponse20060 message(String message) {
  ...
  **/
  ...
  public InlineResponse20060 messageData(Map<String, String> messageData) {
    this.messageData = messageData;
    return this;
  }

  public InlineResponse20060 putMessageDataItem(String key, String messageDataItem) {
  ...
  **/
  ...
  public InlineResponse20060 detailedErrorTrace(String detailedErrorTrace) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.response, inlineResponse20060.response) &&
        Objects.equals(this.errorCode, inlineResponse20060.errorCode) &&
        Objects.equals(this.throttleSeconds, inlineResponse20060.throttleSeconds) &&
        Objects.equals(this.errorStatus, inlineResponse20060.errorStatus) &&
        Objects.equals(this.message, inlineResponse20060.message) &&
        Objects.equals(this.messageData, inlineResponse20060.messageData) &&
        Objects.equals(this.detailedErrorTrace, inlineResponse20060.detailedErrorTrace);
  }
