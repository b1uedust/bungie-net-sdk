...
import uk.co.bluedust.model.DestinyDefinitionsDestinyTalentExclusiveGroup;
import uk.co.bluedust.model.DestinyDefinitionsDestinyTalentNodeCategory;
import uk.co.bluedust.model.DestinyDefinitionsDestinyTalentNodeDefinition;
import uk.co.bluedust.model.DestinyDefinitionsDestinyTalentNodeExclusiveSetDefinition;
...
public class DestinyDefinitionsDestinyTalentGridDefinition {
   ...
   * @return maxGridLevel
  **/
  @ApiModelProperty(value = "The maximum possible level of the Talent Grid: at this level, any nodes are allowed to be activated.")
  ...
  **/
  @ApiModelProperty(value = "The meaning of this has been lost in the sands of time: it still exists as a property, but appears to be unused in the modern UI of talent grids. It used to imply that each visual \"column\" of talent nodes required identical progression levels in order to be activated. Returning this value in case it is still useful to someone? Perhaps it's just a bit of interesting history.")
  ...
  **/
  @ApiModelProperty(value = "Talent Nodes can exist in \"exclusive sets\": these are sets of nodes in which only a single node in the set can be activated at any given time. Activating a node in this set will automatically deactivate the other nodes in the set (referred to as a \"Swap\").  If a node in the exclusive set has already been activated, the game will not charge you materials to activate another node in the set, even if you have never activated it before, because you already paid the cost to activate one node in the set.  Not to be confused with Exclusive Groups. (how the heck do we NOT get confused by that? Jeez) See the groups property for information about that only-tangentially-related concept.")
  ...
  **/
  @ApiModelProperty(value = "This is a quick reference to the indexes of nodes that are not part of exclusive sets. Handy for knowing which talent nodes can only be activated directly, rather than via swapping.")
  ...
  **/
  @ApiModelProperty(value = "BNet wants to show talent nodes grouped by similar purpose with localized titles. This is the ordered list of those categories: if you want to show nodes by category, you can iterate over this list, render the displayProperties for the category as the title, and then iterate over the talent nodes referenced by the category to show the related nodes.  Note that this is different from Exclusive Groups or Sets, because these categories also incorporate \"Independent\" nodes that belong to neither sets nor groups. These are purely for visual grouping of nodes rather than functional grouping.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.maxGridLevel, destinyDefinitionsDestinyTalentGridDefinition.maxGridLevel) &&
        ...
        Objects.equals(this.exclusiveSets, destinyDefinitionsDestinyTalentGridDefinition.exclusiveSets) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maxGridLevel, gridLevelPerColumn, progressionHash, nodes, exclusiveSets, independentNodeIndexes, groups, nodeCategories, hash, index, redacted);
  }
