...
import uk.co.bluedust.model.GroupsV2GroupCreationResponse;
...
public class InlineResponse20024 {
  ...
  private GroupsV2GroupCreationResponse response = null;
  ...
  public InlineResponse20024 response(GroupsV2GroupCreationResponse response) {
  ...
  **/
  ...
  public GroupsV2GroupCreationResponse getResponse() {
    return response;
  }

  public void setResponse(GroupsV2GroupCreationResponse response) {
    this.response = response;
  }

  public InlineResponse20024 errorCode(ExceptionsPlatformErrorCodes errorCode) {
  ...
  **/
  ...
  public InlineResponse20024 throttleSeconds(Integer throttleSeconds) {
  ...
  **/
  ...
  public InlineResponse20024 errorStatus(String errorStatus) {
  ...
  **/
  ...
  public InlineResponse20024 messageData(Map<String, String> messageData) {
    this.messageData = messageData;
    return this;
  }

  public InlineResponse20024 putMessageDataItem(String key, String messageDataItem) {
  ...
  **/
  ...
  public InlineResponse20024 detailedErrorTrace(String detailedErrorTrace) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.response, inlineResponse20024.response) &&
        Objects.equals(this.errorCode, inlineResponse20024.errorCode) &&
        Objects.equals(this.throttleSeconds, inlineResponse20024.throttleSeconds) &&
        Objects.equals(this.errorStatus, inlineResponse20024.errorStatus) &&
        Objects.equals(this.message, inlineResponse20024.message) &&
        Objects.equals(this.messageData, inlineResponse20024.messageData) &&
        Objects.equals(this.detailedErrorTrace, inlineResponse20024.detailedErrorTrace);
  }
