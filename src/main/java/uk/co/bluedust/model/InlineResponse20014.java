...
import uk.co.bluedust.model.MessagesResponsesSaveMessageResult;
...
public class InlineResponse20014 {
  ...
  private MessagesResponsesSaveMessageResult response = null;
  ...
  public InlineResponse20014 response(MessagesResponsesSaveMessageResult response) {
  ...
  **/
  ...
  public MessagesResponsesSaveMessageResult getResponse() {
    return response;
  }

  public void setResponse(MessagesResponsesSaveMessageResult response) {
    this.response = response;
  }

  public InlineResponse20014 errorCode(ExceptionsPlatformErrorCodes errorCode) {
  ...
  **/
  ...
  public InlineResponse20014 throttleSeconds(Integer throttleSeconds) {
  ...
  **/
  ...
  public InlineResponse20014 errorStatus(String errorStatus) {
  ...
  **/
  ...
  public InlineResponse20014 messageData(Map<String, String> messageData) {
    this.messageData = messageData;
    return this;
  }

  public InlineResponse20014 putMessageDataItem(String key, String messageDataItem) {
  ...
  **/
  ...
  public InlineResponse20014 detailedErrorTrace(String detailedErrorTrace) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.response, inlineResponse20014.response) &&
        Objects.equals(this.errorCode, inlineResponse20014.errorCode) &&
        Objects.equals(this.throttleSeconds, inlineResponse20014.throttleSeconds) &&
        Objects.equals(this.errorStatus, inlineResponse20014.errorStatus) &&
        Objects.equals(this.message, inlineResponse20014.message) &&
        Objects.equals(this.messageData, inlineResponse20014.messageData) &&
        Objects.equals(this.detailedErrorTrace, inlineResponse20014.detailedErrorTrace);
  }
